...
export class CreateUserDto {
  ...
  @MaxLength(50, { message: 'Ime mora sadrzati manje najvise 50 karaktera.' })
  @MinLength(2, { message: 'Ime mora sadrzati najmanje 2 karaktera.' })
  public readonly firstName: string;

  @IsString({ message: 'Prezime mora sadrzati samo karaktere.' })
  @MaxLength(50, { message: 'Prezime mora sadrzati najvise 50 karaktera.' })
  ...
  @MaxLength(30, {
    message: 'Korisnicko ime mora sadrzati najvise 30 karaktera.',
  })
  @MinLength(3, {
